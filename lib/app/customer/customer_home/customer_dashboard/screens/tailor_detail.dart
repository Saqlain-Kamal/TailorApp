  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Ali Tailor Shop",style: TextStyle(fontSize: 20),),
        actions: const [
          Padding(
            ...
            Expanded(
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return const TailorDetailCard(name: 'Ali Ahmed',).paddingOnly(bottom: 5);
                  }),
            ),
            SizedBox(height: screenHeight(context)*0.05,),
  ...
  Container customContainer(String text) {
    return Container(
            ...
            child: Padding(
              ...
              child: Text(text,style: const TextStyle(fontSize: 11,color: AppColors.greyColor),),
            ),
          );
  }
}
